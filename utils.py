...
def dataloader(input_size, batch_size, dataset):
...
# Initialisation des poids : normalisation sans biais
...
# Affichage des parametres du réseau
...
# Tracé de la loss au cours de l'entrainement
