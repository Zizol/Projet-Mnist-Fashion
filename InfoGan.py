...
class infoGAN(object):
    ...
    def visualize_results(self, epoch, iteration):
        self.G.eval()
        ...
        samples = (samples + 1) / 2
        utils.save_images(samples[:image_frame_dim * image_frame_dim, :, :, :], [image_frame_dim, image_frame_dim],
                          self.result_dir + '/' + self.dataset + '/' + self.model_name + '/' + self.model_name + '_cont_epoch%03d' % epoch + '_iteration%03d' % iteration + '.png')
